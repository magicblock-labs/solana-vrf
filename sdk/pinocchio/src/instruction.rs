...
use crate::consts::{REQUEST_RANDOMNESS_DISCRIMINATOR, REQUEST_REGULAR_RANDOMNESS_DISCRIMINATOR};
use crate::types::RequestRandomness;
...
#[deprecated = "Use the `RequestRandomnessCpi` from the `ephemeral-rollups-pinocchio` crate instead"]
...
mod tests {
    ...
    use super::*;
    use crate::consts::VRF_PROGRAM_ID;
    use crate::types::RequestRandomness;
